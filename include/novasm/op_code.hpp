...
enum class OpCode : uint8_t {
  ...
  AddChar       = 44, // [] (int, int)          -> (string) Combine two characters into a string.
  ...
  AndInt        = 72, // [] (int, int)          -> (int)    Bitwise and two ints.
  OrInt         = 73, // [] (int, int)          -> (int)    Bitwise or two ints.
  XorInt        = 74, // [] (int, int)          -> (int)    Bitwise exclusive-or two ints.
  InvInt        = 75, // [] (int)               -> (int)    Bitwise invert an int.
  LengthString  = 76, // [] (string)            -> (int)    Calc length of a string.
  IndexString   = 77, // [] (int, string)       -> (int)    Get char at index in string (ascii).
  SliceString   = 78, // [] (int, int, string)  -> (string) Substring from start to end (exclusive).
