...
Context::Context(
    ...
    m_lazies{lazies},
    m_fails{fails},
    m_staticIntTable{staticIntTable},
  ...
  if (m_staticIntTable == nullptr) {
    throw std::invalid_argument{"StaticIntTable cannot be null"};
  }
...
auto Context::getStaticIntTable() const noexcept -> StaticIntTable* { return m_staticIntTable; }
